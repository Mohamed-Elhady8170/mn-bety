...
export default function ProductDetails() {
  ...
  if (productLoading || !product) {
    return (
      <section
        className="min-h-screen bg-bg-light pb-20 animate-pulse"
        dir="rtl"
      >
  ...
  const mainImage =
    images[activeImage]?.url ?? "https://via.placeholder.com/800";
  ...
  return (
    <section
      className="min-h-screen bg-bg-light font-sans pb-20 text-right"
      dir="rtl"
    >
      {/* Breadcrumbs - اختياري */}
      ...
      <div className="max-w-7xl mx-auto px-4 grid grid-cols-1 lg:grid-cols-12 gap-10">
        ...
        <div className="lg:col-span-5 space-y-5">
          ...
          <div>
            <h1 className="text-xl font-bold text-text-main mb-1.5 leading-tight">
              {product.name}
            </h1>
            <p className="text-xs text-text-subtle leading-relaxed mb-4 line-clamp-3">
              {product.description}
            </p>
          ...
          <div className="bg-green-50/40 border border-green-100 rounded-xl p-3 flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-[10px] text-text-subtle opacity-80">
                عاين المنتج وادفع عند الاستلام
              </p>
            </div>
          </div>
          ...
          <div className="bg-bg-main border border-border-main rounded-xl p-4 shadow-sm">
            ...
            <button
              key={seller?._id}
              onClick={() =>
                navigate(`/customer/seller-products/${seller?._id}`)
              }
          ...
          <div className="flex items-center gap-3 pt-2">
            ...
            <button
              ...
              className={`w-12 h-12 shrink-0 flex items-center justify-center bg-bg-main border rounded-xl transition-colors ${isFavorite ? "border-red-200 text-red-500" : "border-border-main text-text-subtle hover:text-red-400"}`}
            >
