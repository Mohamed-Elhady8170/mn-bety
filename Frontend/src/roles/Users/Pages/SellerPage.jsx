...
// const MOCK_SELLERS = [
//   { id: 1, name: "مشغل نورة", location: "القاهره", rating: 4.9, reviews: 128, verified: true, specialty: "تطريز يدوي وتراث", image: "https://images.unsplash.com/photo-1438761681033-6461ffad8d80?q=80&w=200&auto=format&fit=crop" },
//   { id: 2, name: "مجوهرات ياقوت", location: "المنوفية", rating: 5.0, reviews: 210, verified: true, specialty: "فضيات وأحجار كريمة", image: "https://images.unsplash.com/photo-1544005313-94ddf0286df2?q=80&w=200&auto=format&fit=crop" },
//   { id: 3, name: "فخاريات الأمل", location: "الدقهليه", rating: 4.8, reviews: 95, verified: false, specialty: "خزف وفخار يدوي", image: "https://images.unsplash.com/photo-1534528741775-53994a69daeb?q=80&w=200&auto=format&fit=crop" },
//   { id: 4, name: "خشب عتيق", location: "دمياط", rating: 4.7, reviews: 64, verified: true, specialty: "نحت وتجارة أخشاب", image: "https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?q=80&w=200&auto=format&fit=crop" },
//   { id: 5, name: "نسيج الجنوب", location: "اسوان", rating: 4.6, reviews: 88, verified: true, specialty: "سدو وحياكة", image: "" },
//   { id: 6, name: "عطور اللافندر", location: "اسكندريه", rating: 4.5, reviews: 120, verified: false, specialty: "زيوت عطرية طبيعية", image: "" },
//   { id: 7, name: "فن الزجاج", location: "بورسعيد", rating: 4.4, reviews: 42, verified: true, specialty: "زجاج معشق ومزخرف", image: "" },
//   { id: 8, name: "جلود الأصالة", location: "المنيا", rating: 4.3, reviews: 55, verified: true, specialty: "مصنوعات جلدية", image: "" },
// ];
...
//   return (
//     <div className="min-h-screen  bg-bg-main text-text-main py-12 px-4 md:px-20 font-body" dir="rtl">
//       <div className="max-w-4xl mx-auto">
        
//         {/* Header */}
//         <div className="mb-12 animate-fadeIn text-right">
...
//         {/* Search Bar */}
//         <div className="relative mb-10 group animate-fadeIn delay-100">
...
//             className="input-text w-full py-5 pr-14 text-lg dark:bg-bg-dark border border-border-main shadow-sm focus:ring-2 focus:ring-primary/20"
...
//             <Link 
//               key={seller.id}
//               to={`/seller-products/${seller.id}`} 
//               className="card card-hover flex flex-col md:flex-row items-center justify-between p-6 dark:bg-bg-dark group transition-all duration-300 animate-fadeIn"
//               style={{ animationDelay: `${index * 100}ms` }}
//             >
//               <div className="flex items-center gap-6 w-full md:w-auto"> 
                
//                 <div className="relative w-40 h-40 rounded-2xl overflow-hidden border-2 border-border-main group-hover:border-primary/50 transition-colors shrink-0">
//                   <img 
//                     src={seller.image} 
//                     alt={seller.name} 
...
//                     {seller.verified && <BadgeCheck size={20} className="text-primary fill-primary-10" />}
//                   </div>
...
//                   <div className="flex-center gap-1.5 text-yellow-500 font-black text-lg">
//                     <span className="text-text-main">{seller.rating.toFixed(1)}</span>
//                     <Star size={18} fill="currentColor" />
//                   </div>
//                   <span className="text-xs text-text-muted">{seller.reviews} تقييم</span>
//                 </div>
                
//                 <div className="btn btn-outline py-2 px-5 text-sm flex items-center gap-2 group-hover:bg-primary group-hover:text-white border-primary-20 group-hover:border-primary transition-all shadow-sm">
...
export default function SellersPage() {
  ...
  return (
    <div className="min-h-screen bg-bg-main text-text-main py-12 px-4 md:px-20 font-body transition-colors" dir="rtl">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="grid gap-6">
          {filteredSellers.map((seller) => (
            <Link 
              ...
              className="card card-hover flex flex-col md:flex-row items-center justify-between p-6 dark:bg-bg-dark group transition-all duration-300"
            >
              <div className="flex items-center gap-6 w-full md:w-auto"> 
                <div className="relative w-32 h-32 md:w-40 md:h-40 rounded-2xl overflow-hidden border-2 border-border-main group-hover:border-primary/50 transition-colors shrink-0">
                  <img 
                    src={seller.image || "https://via.placeholder.com/200?text=Logo"} 
                    alt={seller.name} 
                    className="w-full h-full object-cover group-hover:scale-110 transition-transform duration-500"
                  />
                  <div className="absolute inset-0 bg-black/5 dark:bg-black/20" />
