    ...
    <section className="card mb-8 animate-fadeIn">
      <div className="flex flex-col sm:flex-row items-center justify-between gap-6">
        <div className="flex flex-col sm:flex-row items-center gap-6">
          ...
          {/* Avatar */}
          <div className="flex-center h-32 w-32 rounded-full bg-bg-subtle border-4 border-primary/20 shadow-xl text-primary relative overflow-hidden">
            {profile?.avatar?.url ? (
              <img
            ...
            {user?.emailVerified && (
              <div
                className="absolute -bottom-1 -right-1 w-8 h-8 bg-green-500 rounded-full flex items-center justify-center border-2 border-bg-main"
