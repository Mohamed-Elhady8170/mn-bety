...
export default function DecoreSection() {
  ...
  const categories = t('home.decore.categories', { returnObjects: true });
  
  const images = [
    "https://i.pinimg.com/736x/af/5d/5e/af5d5e37ac00c764daf917bd9526ff2e.jpg",
    "https://i.pinimg.com/1200x/a4/76/75/a47675dfbe3a66f6da98a00e6c1ac6d3.jpg",
    "https://i.pinimg.com/736x/0b/ea/bc/0beabcfee9be3db72e2c9412cba5d649.jpg",
    "https://i.pinimg.com/1200x/b9/e1/6d/b9e16db82665d7d6bb08ba729c1641fb.jpg"
  ];
