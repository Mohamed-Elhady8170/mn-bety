    ...
    return (
        <section className="bg-bg-light py-20" dir="rtl">
            <div className="container mx-auto px-4">
                ...
                <div className="flex flex-wrap justify-center gap-6.25">
                    {categories.map((cat, index) => (
                        <a
                            key={index}
                            href="#"
                            className="group relative overflow-hidden
                w-45 h-45 border-2 border-border-main
                ...
                hover:rounded-full hover:shadow-xl"
                        >
                            ...
                            <h6 className="relative z-10 text-white text-lg font-bold px-2.5 text-center leading-[1.3] w-full truncate drop-shadow-md">
                                {cat.name}
                            </h6>
                        </a>
                    ))}
