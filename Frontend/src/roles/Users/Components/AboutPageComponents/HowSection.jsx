    ...
    <section className="py-32 bg-primary/5 relative overflow-hidden text-center" dir="rtl">
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
            <div className="relative p-10 bg-bg-main rounded-[3rem] border border-primary/20 group hover:bg-primary transition-all duration-500 ease-in-out">
              <div className="absolute -top-6 right-1/2 translate-x-1/2 md:right-10 md:translate-x-0 w-12 h-12 bg-bg-main shadow-lg rounded-2xl flex items-center justify-center text-2xl font-black text-primary group-hover:bg-text-main group-hover:text-bg-main transition-colors">
                01
              </div>
              ...
              <h3 className="text-2xl font-black text-text-main mb-4 group-hover:text-white transition-colors">نمكن أصحاب الحرف</h3>
