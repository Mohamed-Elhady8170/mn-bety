                        ...
                        <div className="flex justify-between gap-2 sm:gap-4" dir="ltr">
                            {otp.map((digit, index) => (
                                <input
                                    ...
                                    className="w-full aspect-square text-center text-xl md:text-2xl font-bold border-0 border-b-2 border-border-warm focus:border-primary focus:ring-0 bg-transparent transition-all text-text-main outline-none"
                                    maxLength="1"
                                    type="text"
                                    inputMode="numeric"
                                    pattern="\d*"
