                        ...
                        <div className="grid grid-cols-1 gap-3 md:grid-cols-2">
                            ...
                            <div className="flex flex-col gap-1 md:col-span-2 group">
                                ...
                                <div className="relative">
                                    <User className={`absolute right-3 top-1/2 -translate-y-1/2 w-5 h-5 transition-all duration-300 ${touched.fullName && errors.fullName ? 'text-red-text' : 'text-text-subtle opacity-50 group-focus-within:opacity-100 group-focus-within:text-primary'}`} />
                                    <input
                                        name="fullName"
                                        value={formData.fullName}
                                        onChange={handleChange}
                                        onBlur={handleBlur}
                                        className={`w-full rounded-xl border ${touched.fullName && errors.fullName ? 'border-red-text' : 'border-border-warm'} bg-bg-subtle py-2.5 pr-10 pl-3 text-sm focus:ring-2 focus:ring-primary/20 focus:border-primary transition-all duration-300 outline-none text-text-main placeholder:text-text-subtle group-focus-within:shadow-lg group-focus-within:shadow-primary/10`}
                            ...
                            <div className="flex flex-col gap-1 md:col-span-2 lg:col-span-1 group">
                                ...
                                <div className="relative">
                                    <Mail className={`absolute right-3 top-1/2 -translate-y-1/2 w-5 h-5 transition-all duration-300 ${touched.email && errors.email ? 'text-red-text' : 'text-text-subtle opacity-50 group-focus-within:opacity-100 group-focus-within:text-primary'}`} />
                                    <input
                                        name="email"
                                        value={formData.email}
                                        onChange={handleChange}
                                        onBlur={handleBlur}
                                        className={`w-full rounded-xl border ${touched.email && errors.email ? 'border-red-text' : 'border-border-warm'} bg-bg-subtle py-2.5 pr-10 pl-3 text-sm transition-all duration-300 outline-none text-text-main placeholder:text-text-subtle group-focus-within:shadow-lg group-focus-within:shadow-primary/10`}
                            ...
                            <div className="flex flex-col gap-1 md:col-span-2 lg:col-span-1 group">
                                ...
                                <div className="relative">
                                    <Phone className={`absolute right-3 top-1/2 -translate-y-1/2 w-5 h-5 transition-all duration-300 ${touched.phone && errors.phone ? 'text-red-text' : 'text-text-subtle opacity-50 group-focus-within:opacity-100 group-focus-within:text-primary'}`} />
                                    <input
                                        name="phone"
                                        value={formData.phone}
                                        onChange={handleChange}
                                        onBlur={handleBlur}
                                        className={`w-full rounded-xl border ${touched.phone && errors.phone ? 'border-red-text' : 'border-border-warm'} bg-bg-subtle py-2.5 pr-10 pl-3 text-sm text-right transition-all duration-300 outline-none text-text-main placeholder:text-text-subtle group-focus-within:shadow-lg group-focus-within:shadow-primary/10`}
                                        dir="ltr"
                            ...
                            <div className="flex flex-col gap-1 md:col-span-2 group">
                                ...
                                <div className="relative">
                                    ...
                                    <input
                                        ...
                                        onChange={handleChange}
                                        onBlur={handleBlur}
                                        className={`w-full rounded-xl border ${touched.password && errors.password ? 'border-red-text' : 'border-border-warm'} bg-bg-subtle py-2.5 pr-10 pl-9 text-sm transition-all duration-300 outline-none text-text-main placeholder:text-text-subtle group-focus-within:shadow-lg group-focus-within:shadow-primary/10`}
                                        placeholder="********"
