                ...
                <div className="p-6 md:p-8 flex flex-col gap-6">
                    ...
                    <div className="flex flex-col gap-3 text-right animate-fadeIn">
                        ...
                        <p className="text-[#956b50] dark:text-[#e7d5cf] text-sm md:text-base font-normal leading-relaxed">
                            لا تقلق، أدخل بريدك الإلكتروني أو رقم هاتفك وسنرسل لك رمزاً لإعادة تعيين كلمة المرور الخاصة بك فوراً.
                        </p>
                    </div>
                    ...
                    <div className="flex flex-col gap-6">
                        <div className="flex flex-col gap-2 group">
                            ...
                            <div className="relative">
                                <Mail className="absolute right-4 top-1/2 -translate-y-1/2 w-5 h-5 text-[#956b50] dark:text-[#e7d5cf] opacity-50 transition-all duration-300 group-focus-within:opacity-100 group-focus-within:text-[#ec4d18] group-focus-within:scale-110" />
                                <input
                                    className="w-full rounded-xl border border-[#e7d5cf] dark:border-[#3d2a24] bg-[#f3ece8] dark:bg-white/5 py-3.5 pr-12 pl-4 text-sm focus:ring-2 focus:ring-[#ec4d18]/20 focus:border-[#ec4d18] transition-all duration-300 outline-none dark:text-white dark:placeholder:text-white/50 group-focus-within:shadow-lg group-focus-within:shadow-[#ec4d18]/10"
                        ...
                        {/* Action Button */}
                        <Link to="/auth/verify-code" className="w-full">
                            <button className="flex w-full cursor-pointer items-center justify-center rounded-xl h-12 bg-[#ec4d18] hover:bg-[#d43d0a] text-white text-base font-bold transition-all shadow-lg shadow-[#ec4d18]/20 hover:shadow-xl hover:shadow-[#ec4d18]/30 active:scale-[0.98] gap-2 group">
                    ...
                    <div className="flex items-center gap-4 py-2">
                        <div className="h-px grow bg-[#e7d5cf] dark:bg-[#3d2a24]"></div>
                        <span className="text-[#956b50] dark:text-[#e7d5cf] text-xs uppercase tracking-widest font-bold">أو</span>
                        <div className="h-px grow bg-[#e7d5cf] dark:bg-[#3d2a24]"></div>
                    </div>
